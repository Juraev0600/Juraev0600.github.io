            ...
            <div class="menuextras">
                <div class="extras">
                    <ul>
                        ...
                        <li><a href="page-login.html">логин</a></li>
                    </ul>
                </div>
            </div>
            <nav id="mainmenu" class="mainmenu">
                <ul>
                    <li class="logo-wrapper"><a href="index.html"><img src="img1/4.PNG" alt="Multipurpose Twitter Bootstrap Template"></a></li>
                    <li class="active">
                        <a href="/">асоси</a>
                    </li>
                    <li>
                        <a href="lesson">дарсҳо</a>
                    </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-footer col-md-4 col-xs-6">
                <h3>Пайвастшави бо мо</h3>
                <p class="contact-us-details">
                    <b>суроға:</b>Шаҳри Хуҷанд, 12мк, хонаи 4, ҳуҷраи 70<br/>
                    <b>телефон:</b> +992 98 907 45 62<br/>
                    <b>телефон:</b> +992 98 444 14 34<br/>
                    <b>Email:</b> <a href="mailto:getintoutch@yourcompanydomain.com">tajproger@gmail.com</a>
                </p>
            </div>
            <div class="col-footer col-md-2 col-xs-6">
                <h3>Мо дар шабакаҳои иҷтимои</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="footer-copyright">&copy; TAJproger 2021</div>
            </div>
        </div>
    </div>
</div>
